...
import question_generation_Q2 as qg
import question_answering_Q2 as qa
from score_Q2 import f1_score, clean_text
...
def get_response_score(response, knowledge, gen_method, single, remove_personal):
    ...
    for cand in candidates:
        ...
        #     questions = qg.get_questions_sample(cand, response)
            ...
            print("You need to precise the decoding method (only 'beam' supported for now)")
